...
describe('pickConfidentMatch', () => {
    ...
    it('prefers an exact-year series over an older, more popular namesake', () => {
        ...
        // Indian series translated as "Похищение" (2018, 26 votes) collided
        // with the Russian 2026 series of that name (4 votes). The older row
        // is admitted only by the running-season tolerance and used to win
        // the popularity tiebreak.
        const apharan: TmdbSearchResult = {
            id: 84962,
            name: 'Похищение',
            original_name: 'अपहरण',
        ...
        const pohischenie: TmdbSearchResult = {
            id: 251721,
            name: 'Похищение',
            original_name: 'Похищение',
        ...
        expect(
            pickConfidentMatch(
                [pohischenie, apharan],
                { title: 'Похищение (12 серий)', year: 2026 },
                'tv'
            )
        ).toBe(pohischenie);
    });
