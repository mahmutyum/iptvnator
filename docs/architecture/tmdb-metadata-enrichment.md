...
4. Several admitted results are ranked by **year evidence first**
   ...
   namesake: because TMDB returns titles in the request language, a 2018
   Indian series is listed as "Похищение" in `ru-RU` and outvoted the
   Russian 2026 series of that name, rendering its poster, cast and genres.
   Over 400 Russian series titles from a real catalog, 20 normalized keys
